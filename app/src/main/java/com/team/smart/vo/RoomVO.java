...
public class RoomVO extends BaseRespon {
    ...
    public RoomVO(String r_img, String r_name, String r_type, String r_price, String r_reposit, String r_ofer_fee, String r_floor, String r_indi_space, String r_able_date, String regidate) {
        this.r_img = r_img;
        this.r_name = r_name;
        this.r_type = r_type;
